			...
			*/
			...
			switch (result) {
				case '1':
					...
					$('.gift-label').html('少女指数这么低，<br>赶紧点这里领个红包恢复下你的少女风采吧！');
					break;
				case '2':
					document.title = '我的少女指数鉴定结果是：离少女越来越远了！你也快来测试拿红包吧！';
					$('.gift-label').html('少女指数有点低哦，<br>赶紧点这里领个红包恢复下你的少女风采吧！');
					break;
				case '3':
					document.title = '我的少女指数鉴定结果是：有少女的一面！你也快来测试拿红包吧！';
					$('.gift-label').html('少女指数还不错哦，<br>赶紧点这里领个红包继续加强你的少女风采吧！');
					break;
				case '4':
					document.title = '我的少女指数鉴定结果是：少女指数爆棚！你也快来测试拿红包吧！';
					$('.gift-label').html('哇！少女指数这么高！<br>我们决定要奖励你一个少女红包，快来点击领取！');
					break;
				default:
			}
		} else {
